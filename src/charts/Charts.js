    ...
    <MainArea>
      {(props.scenarioSelection.showWelcome===true) && <Welcome closeWelcome={props.closeWelcome} />}
        {(props.scenarioSelection.showDifference===false || (props.scenarioSelection.showDifference===true && selectedScenario2==="")) && 
          <Flex>
            <StackedBarChart chartName='_CO2 emissioner og VE andel' chartTitle='CO2-emissioner og VE-andel' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="Kt" minY={-5000} maxY={40000} minY2={0} maxY2={1} label2="Vedvarende energi andel" Y2Percentage={true} />
            ...
            <StackedBarChart chartName='_El netto eksport' chartTitle='El-netto-eksport' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Netto eksport (PJ)" minY={-100} maxY={160}  minY2={-100} maxY2={160} Y2Percentage={false} />
        ...
        {(props.scenarioSelection.showDifference===true && selectedScenario2!=="") && 
          <Flex>
            <StackedBarDiffChart chartName='_CO2 emissioner og VE andel' chartTitle='CO2-emissioner og VE-andel' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="Kt" minY={-6000} maxY={6000} minY2={-0.16} maxY2={0.16} label2="Vedvarende energi andel" Y2Percentage={true} />
            ...
            <StackedBarDiffChart chartName='_El netto eksport' chartTitle='El-netto-eksport' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Netto eksport (PJ)" minY={-50} maxY={50}  minY2={-60} maxY2={60} Y2Percentage={false} />
            <StackedBarDiffChart chartName='_Fjernvarmeproduktion' chartTitle='Fjernvarme-produktion' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="PJ" minY={-20} maxY={20} />
            <StackedBarDiffChart chartName='_Husholdningers varmeforbrug' chartTitle='Husholdningers varmeforbrug' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Energibesparelser (PJ)" minY={-5} maxY={5} minY2={-5} maxY2={5} Y2Percentage={false} />
            <StackedBarDiffChart chartName='_Industriens energiforbrug' chartTitle='Industriens energiforbrug' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Energibesparelser (PJ)" minY={-40} maxY={40} minY2={-5} maxY2={5} Y2Percentage={false} />
            ...
            <StackedBarDiffChart chartName='_Miljø og energi afgifter' chartTitle='Miljø- og energi-afgifter' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="mia.kr" divideValues={1000} minY={-12000} maxY={12000} />
